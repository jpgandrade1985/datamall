...
def graphs(filtered_df):
    ...
    #Subtitle
    st.subheader("Vendas")
    st.markdown(''':blue-background[Selecione apenas um shopping]''')
   
    col1, col2, col3 = st.columns(3)
    
    with col1:
        st.write("vendas ano x ano")
        fig1 = px.line(filtered_df, color_discrete_sequence=px.colors.qualitative.Set2, x="nome_mes", y="venda_total", color='ano')
